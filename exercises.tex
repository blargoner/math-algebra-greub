...
\begin{rmk}
In Proposition~7.1.1, (1)~is essentially the correlate of~(6.20) for~\(D_L\), and (2)~also follows from the corresponding result about~\(D_E\).\footnote{See the remark in chapter~6, \S~10 above.} We also have
