...
\end{align*}
The linear map \(f:(\medeprod^p E^*)\tprod(\medeprod^q E)\to H\) induced by~\(\gamma\) satisfies \(f\after\varphi=\psi\) and is unique with this property.
\end{rmk}
