...
\end{align*}
This is~(4.21) in~\cite{greub1}, which was proved there using the equivalent of the universal property of~\(\medeprod^n_n(E^*,E)\). This shows that \(\Delta,\Delta^*\) are dual if and only if \(e^*,e\) are dual. Turning the argument around yields an alternative proof of Theorem~6.8.1(1).
\end{rmk}
