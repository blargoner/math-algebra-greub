...
which expresses the classical Laplace expansion of~\(\det M\) by minors from any \(p\)~rows of~\(M\) and their corresponding cofactors.\footnote{See also problem~7.9.9.}
\end{rmk}
