...
where \((\lambda_{p+1},\ldots,\lambda_n)\) is the ordered \((n-p)\)-tuple complementary to \((\lambda_1,\ldots,\lambda_p)\) and \((\nu_{p+1},\ldots,\nu_n)\) is the ordered \((n-p)\)-tuple complementary to \((\nu_1,\ldots,\nu_p)\).
\end{exer}
\begin{proof}
