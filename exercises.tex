...
\begin{rmk}
The flip operator \(Q_E:\medeprod(E^*,E)\to\medeprod(E,E^*)\) restricts to an operator
\[Q_E^{p,q}:\medeprod^p_q(E^*,E)\to\medeprod^q_p(E,E^*)\]
It follows that \(Q_E^*=Q_{E^*}\) and \((Q_E^{p,q})^*=Q_{E^*}^{p,q}\).
\end{rmk}
...
where \(\omega_{E^*}(u^*)=(-1)^{p(n-p)}u^*\) for \(u^*\in\medeprod^p E^*\).
\end{rmk}
