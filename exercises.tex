...
where \((u,v)\)~denotes the greatest common divisor of \(u\) and~\(v\), and \([u,v]\)~denotes the least common multiple of \(u\) and~\(v\).\footnote{See subsections 6.27 and~6.28 of~\cite{greub3}.}
\end{rmk}
