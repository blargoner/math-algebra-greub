...
\[\unit^p=\sum_{<}e^{\nu_1\cdots\nu_p}\tprod e_{\nu_1\cdots\nu_p}\]
where
\[e^{\nu_1\cdots\nu_p}=e^{*\nu_1}\eprod\cdots\eprod e^{*\nu_p}\qquad\text{and}\qquad e_{\nu_1\cdots\nu_p}=\eprods{e}{\nu_1}{\nu_p}\]
for each ordered \(p\)-tuple \(1\le\nu_1<\cdots<\nu_p\le n\). If \(\bar{e}_i=\varphi e_i\) and \(\bar{e}^{*i}=(\varphi^*)^{-1}e^{*i}\), then \(\bar{e}_i,\bar{e}^{*i}\) is another pair of dual bases in \(E,E^*\) and
\begin{align*}
...
\end{proof}
\begin{rmk}
This result shows that insertion is dual to multiplication under Poincar\'e duality.
\end{rmk}
